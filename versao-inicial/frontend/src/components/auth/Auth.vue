    ...
    <div class="auth-content">
        <div class="auth-modal">
            ...
            <a href @click.prevent="showSignup = !showSignup">
                ...
                <span v-else>Não tem cadastro? Resgistre-se aqui</span>
            </a>
        </div>
    </div>
</template>
...
<style>
    ...
    .auth-modal hr{
        ...
        width: 100%;
        height: 1px;
        background-image: linear-gradient(to right,rgb(120,120,120,0),rgba(120,120,120,0.7),rgba(120,120,120,0));
    }
</style>