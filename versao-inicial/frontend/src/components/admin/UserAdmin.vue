<template>
    <div class="user-admin">
        <b-form>
            ...
            <b-form-checkbox id="user-admin" v-model="user.admin" class="mt-3 mb-3 ml-1" v-show="mode === 'save'">
                Administrador?
            </b-form-checkbox>
             <b-row v-show="mode === 'save'">
                <b-col md="6" sm="12">
                    <b-form-group label="Senha" label-for="user-password">
                        <b-form-input id="user-password" type="password" v-model="user.password" required :readonly="mode === 'remove'"
                ...
                <b-col md="6" sm="12">
                    <b-form-group label="Confirmação de senha" label-for="user-confirm-password">
                        <b-form-input id="user-confirm-password" type="password" v-model="user.confirmPassword" required :readonly="mode === 'remove'"
